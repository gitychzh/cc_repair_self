...
:40005 / :40001  cc-proxy      → _cc /v1/messages      → Anthropic→OpenAI 转换 → glm5.1 v×k cycling
:40002          codex-proxy    → _cx /v1/responses     → Responses→Chat 转换    → glm5.1 v×k cycling
:40003          openai-proxy   → _ol/_oc/_hm chat/completions → OpenAI passthrough → dsv4p v×k cycling

→ :41001 LiteLLM ms_uni41001 (glm5.1v1k1~v10k7 = 70 dep + dsv4pv1k1~v10k7 = 70 dep = 140 dep)
→ ModelScope API
```
