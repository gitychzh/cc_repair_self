...
:40006  hm-proxy             → _hm /v1/chat/completions → LiteLLM 41101-41105 (3-tier fallback, per-tier 5-key RR)
  ...
  NV_MODEL_IDS: glm5.1_hm/kimi_hm/deepseek_hm (3 NV models, minimax removed R38.2, dsv4-pro→dsv4-flash R38.3)
  HM PROXY_TIMEOUT=120, UPSTREAM_TIMEOUT=30 (R38.3: 从 300/60 缩短，减少失败浪费)
...
| PROXY_TIMEOUT | 300 (cc/codex/pass) / 120 (hm) | 120-600 | proxy 请求超时秒；hm-proxy R38.3 从300→120 |
| UPSTREAM_TIMEOUT | 60 (cc/codex/pass) / 30 (hm) | 30-120 | per-key HTTPConnection 超时；hm-proxy R38.3 从60→30；sock.settimeout() 确保 read 超时 |
