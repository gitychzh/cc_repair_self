...
|--------|-------------|-------------|-------------|-------------|
| Total requests | 1887 | 48 | 1227 | 37 |
| Success rate | 99.8% | 100% | 96.7%* | 100% |
| Errors | 2×502, 1×429 | 0 | 41×429 (30 glm5.1 + 12 dsv4p)† | 0 |
| Avg TTFB | 19.0s | 6.0s | 18.6s | 8.4s |
| P50 TTFB | 16.2s | 5.0s | 17.0s | — |
| P90 TTFB | 33.0s | — | 30.9s | — |
| P95 TTFB | — | — | 38.5s | — |
| P99 TTFB | 65.0s | — | 48.9s | — |
...
| MS quota remaining | 150-199 | — | 1314-1534 range, last=1528 | — |
| Burst success rate | — | — | 93.1% inside burst (glm5.1=95%, dsv4p=59%) | — |
| Tool truncation | — | — | 71% reduction, ~10K tok saved | — |

\* *Excluding 429 burst: 100% (628/628 outside 16:05→17:34 window)*
† *429 burst at 16:05→17:34 (87min) — ALL 7 keys' ModelScope TOKEN quota exhausting. 30 glm5.1 429s (95.0% burst success) + 12 dsv4p 429s (59.3% burst success). Same keys across all deployments → both backends affected. dsv4p's smaller pool (77 dep vs 7000) = fewer retry opportunities = lower burst success. Overall burst success 93.1%. Same keys → fallback won't help.*

**06-11 full analysis**: 1227 reqs, 96.7% success (41×429: 30 glm5.1 + 12 dsv4p token-limit burst 16:05→17:34, 87min). Outside burst: 100%. Avg TTFB 18.6s, P95=38.5s, **P99=48.9s (improved vs Jun 10's 65s)**. Max actual=136K (safe margin). **NEW: dsv4p also gets 429 during burst** (same 7 keys = same token quota exhaustion), but burst外 dsv4p 100% success → tier routing still beneficial. dsv4p volume=3% of total, absolute impact small. finish_reason=length: 16 curl tests. Tool truncation: 71% reduction (59K→17K chars, ~10K tokens saved/request), MAX_TOOL_DESC=2000 effective. **dsv4p memory**: 51.88%. **All parameters within range — no changes warranted.**
...
| 06-11 | 1227 | 96.7% (100% excl burst) | 18.6s | 41×429 (30 glm+12 dsv4p) burst 16:05→17:34 (87min), P99=48.9s ✅, R18.2 ✅ |
...
- Jun 11 429 burst: RPM quota was fine (ms_requests_remaining=1705), but ALL 7 keys' token quota exhausting at 16:05 → 41 errors over 87min (16:05→17:34). 30 glm5.1 429s (95.0% burst success) + 12 dsv4p 429s (59.3% burst success). Overall burst success 93.1%.
